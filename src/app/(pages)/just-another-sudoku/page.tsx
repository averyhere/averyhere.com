    ...
    <div className="flex flex-col gap-4 lg:pt-20">
      <header className="flex flex-row gap-4 items-center">
        <div
          className="shadow-lg"
          style={{
            // @ts-expect-error corner shape is not yet in the official types, but it is supported in all modern browsers and we use it with a fallback border radius for Safari
